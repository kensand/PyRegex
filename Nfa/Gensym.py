...
# counter everytime a new statename is requested. In order for it to work well howecer, state names should always be
# generated using this. If they are not however, no error will result, since checks are done to ensure that any two
# nfas can be combined using the same state symbols, although this does reesult in a loss of efficiency, and could be
