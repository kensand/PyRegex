...
class Nfa:
    ...
    def interpretRecurse(self, input, state, depth, maxdepth, verbose):
        ...
        if sym in self.transitions[state]:
            ...
            if verbose:
                print("Made default transition for given symbol " + str(sym) + " in state: " + str(state) + " to states: " +
    ...
    def toDFA(self):
        ...
        return Dfa(states, self.alphabet, trans, start, ends)
    ...
    def copy(self):
        return Nfa(self.states, self.alphabet, self.transitions, self.start, self.ends)
...
if __name__ == "__main__":
    ...
    n = Nfa(states=['q1', 'q2'], alphabet={}, transitions={'q1': {None: ['q2'], "":['q1']},
                                                           'q2': {None: ['q1'], "": ['q2']}},
            start='q1', ends=['q2'])
